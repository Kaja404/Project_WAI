...
<?php czy_zalogowany();?>
    ...
    <br />
    <article>
		<h4><a href="formularz.php">Prześlij zdjęcie</a></h4>
		<h4 ><a href="wyb_zdj.php">Wybrane zdjęcia</a></h4>
		<h4 ><a href="wyszukiwarka.php">Szukaj</a></h4>
		<h4 style="text-align:right;margin:0px" >
		<form method="post"><input type="submit" value="Zapamiętaj wybrane" name="submit"/></h4>

<?php if(isset($_POST['submit'])){ zaznacz();} 
wyswietl_zdjecia(); ?>
		</form>
    </article>
